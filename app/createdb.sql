...
DROP TABLE Media;
DROP TABLE Wuser;
DROP TABLE ClubMediaAssociation;
DROP TABLE ClubEventAssociation;
...
CREATE TABLE IF NOT EXISTS ClubMediaAssociation (
  clubID INTEGER,
  mediaID INTEGER,
  PRIMARY KEY (mediaID, clubID),
  FOREIGN KEY (mediaID) REFERENCES Media(mediaID) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (clubID) REFERENCES Club(clubID) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = MYISAM ;

CREATE TABLE IF NOT EXISTS ClubEventAssociation (
  clubID INTEGER,
  eventID INTEGER,
