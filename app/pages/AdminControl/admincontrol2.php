...
//This checks to see if the username is in the database. 
//It also gives us the $username value with will be used from this point on when needed.
...
elseif($adminchoice == "usertype") {
	...
	|| $adminuserchoice == "NKPAG"){
		...
		if(isset($club)) {
			$stmt = $db->prepare("INSERT INTO JunctionUserClub (username, clubID) VALUES (?, ?, ?)");
